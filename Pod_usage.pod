...
web browser using the (non-CPAN) C<WWWBrowser> module (this will
hopefully change).
...
variables C<XEDITOR>, C<VISUAL>, C<EDITOR> or as default
...
use it one has to install perlindex distribution, see
L<Text::English|Text::English>)
